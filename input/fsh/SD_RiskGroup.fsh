...
Id: pedcan-cancer-risk-assessment
Parent: Observation
...
Id: pedcan-rhabdomyosarcoma-risk-assessment
...
* component[clinical-group-modifier].value[x] from RhabdomyosarcomaClinicalGroupValueModifierVS


//Neuroblastoma//

Profile: NeuroblastomaINRGSSRiskAssessment 
Id: pedcan-neuroblastoma-inrgss-risk-assessment
Parent: CancerRiskAssessment
Title: "Neuroblastoma INRGSS Risk Assessment Profile"
Description: "Risk assessment for neuroblastoma by the International Neuroblastoma Risk Group Staging System (INRGSS)."
* ^extension[FMM].valueInteger = 0
* code = NCIT#C133427 // International Neuroblastoma Risk Group Staging System
* value[x] from NeuroblastomaINRGSSRiskAssessmentVS (required)

//Mantle Cell Lymphoma//

Profile: LymphomaMIPIRiskAssessment
Id: pedcan-lymphoma-mipi-risk-assessment
Parent: CancerRiskAssessment
...
Id: pedcan-ALL-risk-assessment
Parent: CancerRiskAssessment
Title: "ALL Risk Assessment Profile"
Description: "Risk assessment for acute lymphoblastic leukemia (ALL). The assessment is based on based on age, white blood cell count, cytogenetics, day-14 marrow response, and end induction minimal residual disease."
* ^extension[FMM].valueInteger = 0
